...
import { ProductListResponseSchema, ProductSchema } from '../../shared/schemas/api-schemas-simple';
  ...
  test.describe('GET /api/v1/products', () => {
    ...
    test('should filter by category correctly', async () => {
      ...
      if (categories.length > 0) {
        ...
        const response = await apiClient.getProducts({ categoryId: testCategory.id });

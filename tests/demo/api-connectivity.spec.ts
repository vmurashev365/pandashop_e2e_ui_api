...
test.describe('API Connectivity Demo', () => {
  ...
  test('should connect to Pandashop.md API and get response', async ({ request }) => {
  ...
  test('should demonstrate test pyramid architecture', async () => {
    ...
    console.log('   🔷 UI Component Tests: 40 tests (20%) - Component interactions');
    console.log('   🔳 API Tests: 140 tests (70%) - Business logic & contracts');
    console.log('');
    ...
    console.log('   • Pure API tests for performance & contracts (100 API tests)');
